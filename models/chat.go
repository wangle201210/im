...
type Chat struct {
	...
	Content     string  	`json:"url" orm:"column(url);type(text)"`
...
func (reg *Chat) Read(fields ...string) error {
...
func (reg *Chat) Update(fields ...string) error {
